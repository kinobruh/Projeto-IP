...
class SalaBase(ABC):
    ...
    # Offsets de renderização do player (câmera → sprite)
    ...
    # ------------------------------------------------------------------
    # Métodos concretos compartilhados por todas as salas
    # ------------------------------------------------------------------
    ...
    def checar_saida(self, player_x: float, screen: pygame.Surface,
        ...
        """
        Verifica se o player está perto da saída e exibe o ícone E.
        Salas com lógica diferente devem sobrescrever este método.
        """
        if player_x < 400:
